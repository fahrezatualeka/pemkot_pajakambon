    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"> Tambah Data Penagihan Pajak Hotel </h3>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <form id="penagihanForm" action="{{ route('penagihan.hotel.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
