...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Pelunasan Pajak Hiburan</li>
  </ol>
</section>
...
<section class="content">
    <div class="box">
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Data Pelunasan Pajak Hiburan</h3>
            ...
            <table class="table table-bordered" id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $pgh_hiburan->tanggal_pelunasan }}</td>
                        ...
                        <td class="text-center">
                            <form action="{{ url('pgh_hiburanPelunasan/delete/'.$pgh_hiburan->id) }}" method="post" style="display: inline-block;">
                                @csrf
                                @method('delete')
