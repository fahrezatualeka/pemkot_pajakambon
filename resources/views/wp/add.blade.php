        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form id="pengawasanForm" action="{{ route('wp.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="omset" id="omset" class="form-control" value="{{ old('omset') }}">
                            </div>

                            <div class="form-group">
                                <label for="pajak">Pajak (%) / Tahun</label>
                                <input type="number" name="pajak" id="pajak" class="form-control" value="{{ old('pajak') }}">
                            </div>

                            <div class="form-group">
                                <label for="sptpd">SPTPD</label>
                                <input type="file" name="sptpd" id="sptpd" class="form-control" value="{{ old('sptpd') }}">
                            </div>
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                {{-- <div class="pull-right">
                                    <a href="{{ url('form_datapenjualan_wajibpajak') }}" class="btn btn-primary btn-normal">
                                        <i class="fa fa-user"></i> Kirim Form Pengisian
                                    </a>
                                </div> --}}
                            </div>
