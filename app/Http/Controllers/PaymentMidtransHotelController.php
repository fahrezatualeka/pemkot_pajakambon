...
class PaymentMidtransHotelController extends Controller
{
    public function payment($id, $npwpd, $nama_pajak, $total){
        ...
        return view('penagihan.hotel.paymentMidtransHotel', compact('payment', 'id'));
    }
    ...
    //     $user = $pgh_hotel->user; // Asumsi relasi antara Pgh_hotel dan User sudah didefinisikan
    
    //     // Panggil fungsi untuk mengarahkan pengguna kembali ke WhatsApp dengan nomor telepon pengguna
    //     return redirect()->route('penagihan.hotel.kirimPesanWhatsApp', $user->no_telepon);
    // }
    ...
    //     $payment = Pgh_hotel::findOrFail($id);
